...
namespace LibraryServices
{
    public class LibraryAssetService : ILibraryAsset
    {
        ...
        {
            return _context.LibraryAssets.Include(asset => asset.Status) // I can just call GetAll() instead of repeating codes
                   .Include(asset => asset.Location)
        ...
        {
            return _context.LibraryAssets.FirstOrDefault(a => a.Id == id)
                   .Title;
        }
